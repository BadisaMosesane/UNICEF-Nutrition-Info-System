...
public class MainActivity extends AppCompatActivity {
    ...
    private void createScatterPlot() {
        ...
        for(int i = 0;i <xyValueArray.size(); i++){
            try{
                double x = xyValueArray.get(i).getWeight();
                double y = xyValueArray.get(i).getHeight();
        ...
        mScatterPlot.getViewport().setMinX(5);
    ...
    private ArrayList<XYValue> sortArray(ArrayList<XYValue> array){
        ...
        while (true) {
            ...
            try {
                ...
                //}
                double tempY = array.get(m - 1).getHeight();
                double tempX = array.get(m - 1).getWeight();
                if (tempX > array.get(m).getWeight()) {
                    array.get(m - 1).setHeight(array.get(m).getHeight());
                    array.get(m).setHeight(tempY);
                    array.get(m - 1).setWeight(array.get(m).getWeight());
                    array.get(m).setWeight(tempX);
                } else if (tempX == array.get(m).getWeight()) {
                    count++;
                    Log.d(TAG, "sortArray: count = " + count);
                } else if (array.get(m).getWeight() > array.get(m - 1).getWeight()) {
                    count++;
                    Log.d(TAG, "sortArray: count = " + count);
                }
